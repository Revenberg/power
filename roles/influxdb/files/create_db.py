...
try:
    ...
    dbclient.create_retention_policy('10_days', '10d', 1, influx_database, default=False)
    dbclient.create_retention_policy('60_days', '60d', 1, influx_database, default=False)
    dbclient.create_retention_policy('infinite', 'INF', 1, influx_database, default=True)
    ...
    dbclient.create_continuous_query("p1_mean", p1_select_clause + ' INTO "10_days"."p1_mean" FROM "p1" GROUP BY time(5m)', influx_database )
    dbclient.create_continuous_query("p1_mean", p1_select_clause + ' INTO "60_days"."p1_mean" FROM "p1" GROUP BY time(5m)', influx_database )
    dbclient.create_continuous_query("p1_mean", p1_select_clause + ' INTO "infinite"."p1_mean" FROM "p1" GROUP BY time(5m)', influx_database )   
    ...
    dbclient.create_continuous_query("solar_mean", solar_select_clause + ' INTO "10_days"."solar_mean" FROM "solar" GROUP BY time(5m)', influx_database )
    dbclient.create_continuous_query("solar_mean", solar_select_clause + ' INTO "60_days"."solar_mean" FROM "solar" GROUP BY time(5m)', influx_database )
    dbclient.create_continuous_query("solar_mean", solar_select_clause + ' INTO "infinite"."solar_mean" FROM "solar" GROUP BY time(5m)', influx_database )
    ...
    dbclient.create_continuous_query("weather_mean", weather_select_clause + ' INTO "10_days"."weather_mean" FROM "weather" GROUP BY time(5m)', influx_database )
    dbclient.create_continuous_query("weather_mean", weather_select_clause + ' INTO "60_days"."weather_mean" FROM "weather" GROUP BY time(5m)', influx_database )
    dbclient.create_continuous_query("weather_mean", weather_select_clause + ' INTO "infinite"."weather_mean" FROM "weather" GROUP BY time(5m)', influx_database )
