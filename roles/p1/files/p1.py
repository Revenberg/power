...
def main(argv=None):
    ...
    influx_group.add_argument("--influx-database", metavar='dbname', dest="influx_database", help="database name to connect to, defaults to 'smartmeter'", default="smartmeter")
